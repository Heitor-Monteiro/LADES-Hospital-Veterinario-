...
CREATE TABLE IF NOT EXISTS `bd_sihv`.`animais` (
  ...
  `idadePeriodo` SET('Semanas', 'Meses', 'Anos') NULL,
  `idadeAtual` INT(3) NULL,
  `peso` DOUBLE NOT NULL,
  `cadDataHora` TIMESTAMP(6) NOT NULL,
  `rghv` VARCHAR(11) NOT NULL,
  `categoriaAnimal` SET('animais domésticos', 'animais silvestres', 'animais de produção') NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bd_sihv`.`anamnese` (
  ...
  `vacinacao` SET('Anti-rábica', 'V8', 'Outras') NOT NULL,
  ...
  `qualEctoparasitas` SET('Ixodidiose', 'Puliciose', 'Phthiraptera') NULL,
